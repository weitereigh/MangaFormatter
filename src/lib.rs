// src/lib.rs
/*
 * Core library for MangaFormatter
 */
...
#[derive(Debug)]
pub struct MangaFormatterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MangaFormatterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MangaFormatter processing");
    
    let mut processor = MangaFormatterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MangaFormatterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MangaFormatterProcessor::new(false);
